...
namespace Demo.Data
{
    public class BaseDbContext<T> : IdentityDbContext where T : IdentityDbContext
    {
        ...
        public LogDbContext LogDbContext { get; } = this.GetService<LogDbContext>();
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            LogDbContext = this.GetService<LogDbContext>();
            LogDbContext.People.Add(new Person { Id = 1, FullName = "SinjulMBH" });
            LogDbContext.SaveChanges();
            var LogDbContext = LogDbContext.People.ToList();
        }
    }
