...
namespace Demo.Data
{
    ...
    {
        public BaseDbContext(DbContextOptions<T> options, LogDbContext logDbContext) : base(options)
    ...
    {
        public ApplicationDbContext(DbContextOptions<ApplicationDbContext> options, LogDbContext logDbContext) : base(options, logDbContext)
        {
        }
